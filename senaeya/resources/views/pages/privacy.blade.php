...
@section('content')
    ...
    <blockquote class="blockquote-footer">Effective date: February 09, 2019</blockquote>
    <div class="border mb-2"></div>
    <p>Senaeya ("us", "we", or "our") operates the http://senaeya.com website (the "Service").

        This page informs you of our policies regarding the collection, use, and disclosure of personal data when you
        use
        our Service and the choices you have associated with that data. Our Privacy Policy for Senaeya is created with
        the
        help of the Free Privacy Policy website.
        ...
        Privacy Policy have the same meanings as in our Terms and Conditions, accessible from http://senaeya.com</p>
    ...
    <h2>Use of Data</h2>
    <p>Senaeya uses the collected data for various purposes:</p>
    ...
    <p>Your information, including Personal Data, may be transferred to — and maintained on — computers located outside
        ...
        If you are located outside United Arab Emirates and choose to provide information to us, please note that we
        transfer the data, including Personal Data, to United Arab Emirates and process it there.

        Your consent to this Privacy Policy followed by your submission of such information represents your agreement to
        that transfer.

        Senaeya will take all steps reasonably necessary to ensure that your data is treated securely and in accordance
        with
    ...
    <p>Senaeya may disclose your Personal Data in the good faith belief that such action is necessary to:</p>

    <ul class="list-styled">
        <li>To comply with a legal obligation</li>
        <li>To protect and defend the rights or property of Senaeya</li>
    ...
    <ul class="list-styled">
        <li>By visiting this page on our website: <a href="/contact" class="text-info">http://senaeya.com/contact/</a>
        </li>
    </ul>
@endsection()
